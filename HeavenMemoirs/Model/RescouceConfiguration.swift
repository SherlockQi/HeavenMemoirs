...
class RescouceConfiguration: NSObject,NSCoding {
    ...
    func encode(with aCoder: NSCoder) {
        aCoder.encode(self.box_Random,            forKey: k_C_box_Random)
        aCoder.encode(self.panorama_isShow,       forKey: k_C_panorama_isShow)
        aCoder.encode(self.video_isPlay,          forKey: k_C_video_isPlay)
        aCoder.encode(self.video_isSilence,       forKey: k_C_video_isSilence)
        aCoder.encode(self.voice_isPlay,          forKey: k_C_voice_isPlay)
        aCoder.encode(self.text_isShow,           forKey: k_C_text_isShow)
        aCoder.encode(self.particle_isShow,       forKey: k_C_particle_isShow)
    }
